			...
			<div class="span8" id="home_content">
				...
				<?php
					...
					foreach($events as $event):
						?><div class="cadacircuito"><div class="textocircuito"><div class="titulocircuito"><image src="<?php bloginfo('template_url'); ?>/img/icoflags.png" alt="" style="margin:-4px 20px 0 13px;" class="cirimico" WIDTH="28"><?php
						echo get_the_title($event->ID); //Titulo del evento
						?></div><div class="fechacircuito"><image src="<?php bloginfo('template_url'); ?>/img/icocal.png" alt="" class="cirimico"><?php
						echo eo_format_date($event->StartDate, 'd\/m\/Y');//fecha del evento
						?></div><div class="paiscircuito"><image src="<?php bloginfo('template_url'); ?>/img/icopin.png" alt="" style="margin: 0 29px 0 10px;" class="cirimico"><?php
						the_field("pais", $event->ID); //Pais del circuito
						?></div><div class="circuitocircuito"><image src="<?php bloginfo('template_url'); ?>/img/icocasco.png" alt="" class="cirimico" WIDTH="19"><?php
